...
We can visually evaluate the convergence analysing the Figure \ref{figure:fig001}:
...
In this example we can postulated a Bernouli trial for each Specie and Location, and we are able to use the \code{lda_bernoulli} function, for which we need to specify the follow arguments:
